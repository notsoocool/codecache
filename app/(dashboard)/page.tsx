...
export default function Home() {
  return (
    <ReactLenis root>
      <main className="my-8 mx-5">
		<div className="md:mt-52 mb-20 flex  ">
		<div>
		<h1 className=" md:w-3/5 md:text-[68px] text-5xl md:leading-snug font-serif">
		Boost productivity with <span className="font-bold ">CodeCache!</span>
		</h1>
		<div className="md:w-3/4">
		<p className=" py-4">
          Welcome to <strong>CodeCache</strong>, your go-to platform for
          managing code snippets effectively. CodeCache is designed to simplify
          how developers handle code snippets by offering a customizable,
          searchable, and easy-to-use interface. Whether you are building a
          small project or working on large-scale applications, CodeCache helps
          you stay organized and productive.
        </p>
		</div>
		<div className="mt-4">
			<button className="underline underline-offset-4 decoration-dotted">Know more</button>
		</div>
		</div>
		<div className="border-2 w-3/4 opacity-10">
			<Image src='/code.png' width={600} height={100} alt="img" />
		</div>
		</div>
  ...
  <div className="flex flex-wrap md:flex-nowrap gap-4">
    {[
      { title: "Snippet Management", description: "Easily create, edit, and organize your code snippets by language, tags, or custom categories." },
      { title: "Search Functionality", description: "Quickly find the code you need with an advanced search feature." },
      { title: "Customization", description: "Tailor the code snippets with custom descriptions and tags, making them easy to reference." },
      { title: "Multi-language Support", description: "Store snippets in multiple programming languages, including JavaScript, Python, Go, and more." },
      { title: "Sharing Options", description: "Share your favorite snippets with your team or community effortlessly." }
    ].map((feature, index) => (
      <div
        key={index}
      ...
      >
        ...
        <p className="text-sm dark:text-slate-300 ">{feature.description}</p>
      </div>
    ))}
  </div>
</div>
